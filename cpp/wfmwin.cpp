...
DEFINE_RESPONSE_TABLE1(WfmWin, Draw3D)
  EV_WM_SIZE,
END_RESPONSE_TABLE;

IMPLEMENT_CASTABLE1(WfmWin, Draw3D);
...
// <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>
// <<>>                                                  <<>>
// <<>>       Member functions of Class WfmWin       <<>>
// <<>>                                                  <<>>
// <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>  <<>>
...
void WfmWin::SetWireframeObj(Wfm3D *Obj)
 {
   Wfm = Obj;
 }

void WfmWin::EvSize(UINT sizeType, TSize& size)
 {
   Draw3D::EvSize(sizeType, size);
   Invalidate();
 }
